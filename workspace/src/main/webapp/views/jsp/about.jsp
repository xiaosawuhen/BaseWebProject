			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<h2>Who We Are</h2>
						<p>
							Lorem ipsum dolor sit amet, fusce elementum vehicula, magna elementum pede eros, ante elementum. Urna scelerisque mi sollicitudin neque amet dui, augue erat. Tortor fusce erat proin quisque sed lorem, justo eu.
						</p>
						<p class="button">
							<a href="#">Read More</a>
						</p>
		...
		<section class="team-v2">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="heading-normal">
							<h2>Our Qualified Team Members</h2>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						...
						<div class="team-carousel">
							...
							<div class="item">
								...
								<div class="text">
									<h3><a href="">Patrick Henderson</a></h3>
									<p>Director</p>
