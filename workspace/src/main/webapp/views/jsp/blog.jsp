			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/1.jpg" alt="">
								<div class="date">
							...
							<div class="text">
								...
								<ul class="status">
									...
									<li><a href=""><i class="fa fa-user"></i>Author: Ricky Ponting</a></li>
								</ul>
								<p>
					...
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/2.jpg" alt="">
								<div class="date">
									<div class="day">24</div>
									<div class="month">MAY</div>
								</div>
					...
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/3.jpg" alt="">
								<div class="date">
									<div class="day">24</div>
									<div class="month">MAY</div>
								</div>
					...
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/4.jpg" alt="">
								<div class="date">
									<div class="day">24</div>
									<div class="month">MAY</div>
								</div>
					...
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/5.jpg" alt="">
								<div class="date">
									<div class="day">24</div>
									<div class="month">MAY</div>
								</div>
					...
					<div class="col-md-4">
						<div class="post-item">
							<div class="image-holder">
								<img class="img-responsive" src="images/gallery/thumbnail/6.jpg" alt="">
								<div class="date">
									<div class="day">24</div>
									<div class="month">MAY</div>
								</div>
