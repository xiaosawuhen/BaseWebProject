...
<head>
  ...
  <script>
	...
	$(document).ready(function() {
		//var vdata = [];
	    var employeeTable = $('#newsTable').DataTable( {
              	...
              	if(data.statusCode = '20000') {
      		    	...
      		    	if(dataList.length > 0) {
                  		...
                  		$.each(dataList, function(i, item){
                  			...
                  			arrary[0] = (i);
                  			arrary[1] = ((dataList[i].nid!=null)?dataList[i].nid:"");

                  			var title = ((dataList[i].title!=null)?dataList[i].title:"");
    		    			var nameHtml = "<span ";
    		    			nameHtml += "nid='"+dataList[i].nid+"' >";
    		    			nameHtml += "<a class=\"news-name\" href='javascript:void(0);' onclick='detailIfno(this)'";
    		    			nameHtml += ">"+title+"</a></span>";
    		    			
                  			arrary[2] = nameHtml;
                  			arrary[3] = ((dataList[i].description!=null)?dataList[i].description:"");
                  			tableData[i] = arrary;
                  		});
                  		employeeTable = $("#newsTable").dataTable();   
